...
import 'package:food/upload_priview.dart';
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const UploadPriview(),
                          ));
                    },
                    child: Container(
                      height: height / 7,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("From Gallery", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: text * 12)),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: height * 0.01),
                          Text("Take Photo", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: text * 12)),
                        ],
                      ),
                    ),
                  ),
